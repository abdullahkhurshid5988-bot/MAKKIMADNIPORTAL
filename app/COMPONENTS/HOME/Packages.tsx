...
const HAJJ_PACKAGES: HajjPackage[] = [
  {
    ...
    startingPrice: "Starting from PKR 2,275,000",
    ...
    details: [
      ...
      "Premium Plan Without Ticket",
      "Qurbani is not included in the package",
      "Azizia accommodation is sharing by default",
      "Separate Azizia room is subject to additional charges",
      "3 Nights Madinah",
      "4 Nights Azizia",
    ...
    itinerary: [
      ...
      "10–13 May: Azizia — Full Board",
      "14–18 May: Hajj Days, Mina, Arafat and Muzdalifah — Full Board",
      "19–20 May: Azizia — Full Board",
...

  {
    ...
    // New uploaded flyer image for 17 Days package
    image: "/images/21 days(1).jpg",

    downloadName: "Makki-Madni-17-Days-Hajj-Package.jpg",
    startingPrice: "Starting from PKR 2,525,000",
...

  {
    ...
    startingPrice: "Starting from PKR 2,675,000",
...
function createWhatsAppMessage(pkg: HajjPackage) {
  const pricing = pkg.prices
    .map(
      (price) => `${price.room} Package
PKR ${price.pkr}
...
Please send me availability, required documents, payment procedure and booking details.
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-black/60 sm:text-lg">
            Select your preferred Hajj package, view complete prices and
            itinerary, download the flyer or book directly through WhatsApp.
          </p>
        </div>
            ...
            return (
              ...
              >
                <div className="relative aspect-[4/5] overflow-hidden bg-[#e8e1d2]">
                  ...
                  <span className="absolute left-5 top-5 rounded-full bg-[#d4af37] px-5 py-2 text-sm font-black text-[#082017] shadow-lg">
                    {pkg.duration}
                  </span>
                </div>
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <details className="mt-5 rounded-3xl border border-[#d4af37]/25 bg-[#fffaf0] p-5">
